...
from .routers import crawler_router, data_router, douyin_router, websocket_router
...
@app.get("/douyin-download")
async def serve_douyin_download():
    """返回抖音下载工具页面"""
    page_path = os.path.join(WEBUI_DIR, "douyin_download.html")
